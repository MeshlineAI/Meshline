...
export function ScanlineOverlay({ className }: { className?: string }) {
  return (
    <div aria-hidden className={cn("pointer-events-none fixed inset-0 z-0 overflow-hidden", className)}>
      {/* brand gradient-mesh blooms — slowly drifting so the page feels alive */}
      <div className="animate-drift-a absolute -top-[16%] left-[6%] h-[60vh] w-[60vh] rounded-full bg-[#00E5FF] opacity-[0.12] blur-[150px]" />
      <div className="animate-drift-b absolute top-[26%] right-[0%] h-[54vh] w-[54vh] rounded-full bg-[#46E0B4] opacity-[0.10] blur-[160px]" />
      <div className="animate-drift-c absolute bottom-[-12%] left-[28%] h-[50vh] w-[60vh] rounded-full bg-[#AEF73C] opacity-[0.07] blur-[180px]" />
